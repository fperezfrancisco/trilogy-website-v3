...
import { LineChart, Trophy, TvMinimalPlay } from "lucide-react";
import { Map } from "lucide-react";
import { TbSoccerField } from "react-icons/tb";
import PricingSectionExample from "../../components/programs/PricingSectionExample";
import PricingSection from "../../components/programs/PricingSection";
import Footer from "../../components/footer/Footer";

const HeroSlideshow = () => {
  const images = ["/private-1.JPG", "/private-2.JPG", "/private-3.JPG"];
...
const EliteMentorshipPage = () => {
  const featureList = [
    {
      title: "Weekly Training",
      description:
        "60 minute, 1-1 training once or twice a week specific to the player needs.",
  ...
  const pricingPlans = [
    {
      ...
      pricing: {
        ...
        Quarterly: {
          price: 825,
          period: "quarter",
          billingInfo: "Save $75 - Billed every 3 months",
        },
        Annually: {
          price: 2500,
          period: "year",
          billingInfo: "Save $1,100 - Billed annually.",
        },
      },
      features: [
        "Weekly 60 minute 1-on-1 training sessions",
    ...
    },
    {
      ...
      pricing: {
        ...
        Quarterly: {
          price: 1500,
          period: "quarter",
          billingInfo: "Save $225 - Billed every 3 months.",
        },
        Annually: {
          price: 4500,
          period: "year",
          billingInfo: "Save $2400 - Billed annually.",
        },
      },
      features: [
        "2 Weekly 60 minute 1-on-1 training sessions",
        "Monthly Player Check-Ins",
        "Tactical Video Analysis",
        "Individual Player Plan",
      ...
      <main className="w-full max-w-[2400px] mx-auto mt-[56px] my-0 flex flex-col">
        <section className="w-full max-w-[1440px] mx-auto mt-[0px] h-full min-h-[700px] overflow-x-hidden p-4 md:p-8 flex flex-col items-center justify-center min-[800px]:flex-row min-[800px]:items-center md:justify-start relative">
          <div className="flex flex-col items-center text-center min-[800px]:items-start min-[800px]:text-left w-full min-[800px]:w-1/2 min-[800px]:max-w-[600px] p-0 min-[800px]:py-4 min-[800px]:relative min-[800px]:z-10">
            ...
            <p className="text-base md:text-lg tracking-[-0.5px] leading-tight max-w-[80%]">
              ...
              Mentorship for Highly Committed Players Ready to Level Up —
              Limited Elite Spots Available (Ages 10+).
            </p>
        ...
        <section className="w-full max-w-[1440px] mx-auto h-full p-4 md:py-[64px] md:px-8 flex flex-col items-center ">
          <div className="w-full max-w-[800px] flex-col flex items-center text-center">
            <h2 className="text-3xl md:text-4xl font-semibold italic tracking-[-2px] leading-tight mb-4">
              <span className="text-blue-500">Purpose-Driven</span> Training.
              Built with a <span className="text-blue-500">Plan</span>.
            </h2>
            <p className="text-base tracking-[-0.5px] leading-tight">
              The Elite 1-on-1 Mentorship Program is a high-commitment
              development pathway for competitive youth soccer players who are
              serious about long-term improvement. Unlike standard private
              training, this program provides a structured, results-driven
              approach that includes weekly 60-minute personalized training
              sessions tailored to each player’s technical, physical, and
              positional needs. Every player begins with a detailed evaluation
              and receives an individual development plan, supported by monthly
              check-ins to ensure progress both on and off the field. Players
              also receive a monthly tactical video review session to sharpen
              game awareness, decision-making, and soccer IQ. This program is
              offered on a monthly, quarterly, or annual commitment basis,
              rewarding consistency and accountability while delivering stronger
              results at better value. Our focus is simple: committed players,
              clear structure, and measurable progress toward the next level.
            </p>
          </div>
        ...
        <section className="w-full max-w-[1440px] mx-auto h-full p-4 md:py-[64px] md:px-8 flex flex-col items-center ">
          <div className="w-full max-w-[800px] flex-col flex items-center text-center">
            ...
            <p className="text-base tracking-[-0.5px] leading-tight">
              What you can expect from the Elite 1-on-1 Mentorship Program:
            </p>
          </div>
        ...
        <section className="w-full max-w-[1440px] mx-auto h-full p-4 md:py-[64px] md:px-8 flex flex-col md:flex-row items-center md:items-start md:flex-start gap-8">
          <div className="w-full max-w-[600px] flex-col flex items-center text-center md:items-start md:text-left">
            ...
            <p className="text-base tracking-[-0.5px] leading-tight">
              All the steps to get started with the Elite 1-on-1 Mentorship
              Program:
            </p>
            ...
            <div className="flex items-start gap-4 w-full">
              ...
              <div className="flex flex-col items-start w-full">
                ...
                <p className="text-sm md:text-base text-neutral-700 leading-tight">
                  Fill out our Elite 1-1 application to initiate the process. We
                  will need important contact information, desired training
            ...
            <div className="flex items-start gap-4 w-full">
              ...
              <div className="flex flex-col items-start w-full">
                ...
                <p className="text-sm md:text-base text-neutral-700 leading-tight">
                  ...
                  payment & final form completion at this step.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-4 w-full">
              ...
              <div className="flex flex-col items-start w-full">
                ...
                <p className="text-sm md:text-base text-neutral-700 leading-tight">
                  We will conduct a first evaluation to get an up-close look at
                  the player’s individual baseline skill set in each phase of
                  the game - technical, tactical, physical, and mental. This can
                  be either individually or in a small group.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-4 w-full">
              ...
              <div className="flex flex-col items-start w-full">
                ...
                <p className="text-sm md:text-base text-neutral-700 leading-tight">
                  Finally, we begin to train consistently on the designated time
                  and finalize the individual player plan set. Each month,
                  player & parent are encouraged to setup a check-in time as
                  well as tactical analysis review.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className=" w-full h-full min-h-[500px] flex relative overflow-hidden p-4 md:p-8 flex-col justify-center md:justify-normal md:flex-row items-center gap-8 rounded-2xl ">
            <div className="z-50 flex flex-col items-center md:items-start text-center justify-center md:justify-normal md:text-left text-white max-w-[800px] w-full h-full md:w-2/3">
              ...
              <p className="text-base md:text-lg tracking-[-0.5px] leading-tight max-w-[80%]">
                ...
                started on the best development plan right away. Limited 1-1
                Mentorship Slots.
              </p>
              <div className="mt-6 flex flex-wrap gap-2 w-full justify-center min-[800px]:justify-start">
                <Link
...
export default EliteMentorshipPage;
